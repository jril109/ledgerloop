...
export default async function ExpensesPage() {
  ...
  // TODO(LED-7/LED-8): replace with the shared month-selector hook used by
  // Dashboard + Income once it lands. Until then the active month is "today".
  const activeMonth = currentMonthKey();

  // TODO(LED-114): hydrate from the authenticated DataFileProvider (Drive +
  // decrypt) once available. Placeholder empty seed for now so the UI renders.
